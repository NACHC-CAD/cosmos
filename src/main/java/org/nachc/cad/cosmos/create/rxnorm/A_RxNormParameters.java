...
public class A_RxNormParameters {
	...
	public static final String CSV_DIR = ApplicationProperties.getRxNormRrfDir();
	
	public static final String DATABRICKS_DIR = ApplicationProperties.getRxNormDatabricksDir();
